<template>
  <div
      :class="['zent-design-component-richtext-preview',{'zent-design-component-richtext-preview--fullscreen': fullscreen}]"
      :style="{backgroundColor: backgroundColor}"
      v-html="content || emptyRichtext"></div>
</template>
